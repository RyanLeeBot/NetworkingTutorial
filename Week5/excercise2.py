...
def BuildIP(base_network='10.10.10.'):

    last_octet = random.randint(1, 254)
    return base_network + str(last_octet)

print(BuildIP()) #no argument
print(BuildIP('192.168.4.')) #positional argument
print(BuildIP(base_network='172.16.10.')) #named argument